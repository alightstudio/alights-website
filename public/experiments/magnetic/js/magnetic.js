Magnetic = new function(){
	...
	var skins = [{
		...
		glowA: 'rgba(255,255,255,0.2)',
		glowB: 'rgba(255,255,255,0.0)',
		particleFill: 'rgba(255,255,255,0.7)',
		fadeFill: 'rgba(22,22,22,.6)',
		useFade: true
	}, {
		glowA: 'rgba(255,255,255,0.2)',
		...
		glowA: 'rgba(255,255,255,0.0)',
		glowB: 'rgba(255,255,255,0.0)',
		particleFill: '#333333',
		fadeFill: 'rgba(255,255,255,.2)',
		useFade: true
	}, {
		glowA: 'rgba(255,255,255,0)',
		glowB: 'rgba(255,255,255,0.0)',
		particleFill: '#ffffff',
		fadeFill: '',
		useFade: false
	...
	function windowResizeHandler() {
		...
		seeMore.style.left = cvx + 'px';
		seeMore.style.top = cvy - 20 + 'px';
	}
